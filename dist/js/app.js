(() => {
    ...
    function initSliders() {
        if (document.querySelector(".image__swiper")) new core(".image__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    $(document).ready((function() {
        ...
        $(window).scroll((function() {
            if ($(this).scrollTop() > 50 && $menu.hasClass("default")) $menu.removeClass("default").addClass("fixed"); else if ($(this).scrollTop() <= 50 && $menu.hasClass("fixed")) $menu.removeClass("fixed").addClass("default");
        }));
    }));
    $(document).ready((function() {
